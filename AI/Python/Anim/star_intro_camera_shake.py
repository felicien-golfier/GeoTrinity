...
try:
    toolkit, curves = {}, {}
    for path, module in ((unreal.Paths.project_dir() + "AI/Python/Anim/anim_sequence_authoring.py", toolkit),
                         (unreal.Paths.project_dir() + "AI/Python/Asset/curve_asset_authoring.py", curves)):
