...
<!-- [2026-04-13] No .h or .cpp files in today's diff (git diff --name-only HEAD returned empty; latest commits only modified .uasset, .ini, and .md files). Nothing to document. -->
