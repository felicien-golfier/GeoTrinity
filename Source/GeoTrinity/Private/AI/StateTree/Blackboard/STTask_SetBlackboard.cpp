...
#include "AI/StateTree/Blackboard/STTask_SetBlackboard.h"

#include "AI/GeoAIBlackboardComponent.h"
#include "StateTreeExecutionContext.h"
#include "StateTreeLinker.h"

bool FSTTask_SetBlackboard::Link(FStateTreeLinker& Linker)
{
	Linker.LinkExternalData(BlackboardHandle);
	return true;
}

EStateTreeRunStatus FSTTask_SetBlackboard::EnterState(FStateTreeExecutionContext& Context,
