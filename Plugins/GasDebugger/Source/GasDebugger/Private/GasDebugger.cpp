...
#endif
	FGlobalTabmanager::Get()->RegisterNomadTabSpawner(GASAttachEditorTabName, FOnSpawnTab::CreateRaw(this, &FGasDebuggerModule::OnSpawnPluginTab))
...
TSharedPtr<SWidget> FGasDebuggerModule::CreateGASCheckTool()
{
