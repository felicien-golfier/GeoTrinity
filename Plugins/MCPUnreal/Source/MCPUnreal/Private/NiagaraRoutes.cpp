...
namespace MCPUnreal {
  ...
  static bool HandleNiagaraOps(FHttpServerRequest const& Request,
                               FHttpResultCallback const& OnComplete) {
#if WITH_NIAGARA
    ...
    FString const Operation = Body->GetStringField(TEXT("operation"));
    ...
    if (Operation == TEXT("spawn_system")) {
      FString const SystemPath = Body->GetStringField(TEXT("system_path"));
      ...
      TArray<TSharedPtr<FJsonValue>> const* LocArray;
      ...
      TArray<TSharedPtr<FJsonValue>> const* RotArray;
      ...
      TArray<TSharedPtr<FJsonValue>> const* ScaleArray;
    ...
    if (Operation == TEXT("set_parameter")) {
      FString const ActorPath = Body->GetStringField(TEXT("actor_path"));
      FString const ParamName = Body->GetStringField(TEXT("parameter_name"));
      FString const ParamType = Body->GetStringField(TEXT("parameter_type"));
      ...
      if (ParamType == TEXT("float")) {
        ...
        TArray<TSharedPtr<FJsonValue>> const* VecArray;
        ...
        TArray<TSharedPtr<FJsonValue>> const* ColArray;
    ...
    if (Operation == TEXT("get_system_info")) {
      ...
      for (FNiagaraEmitterHandle const& Handle : NiagaraSystem->GetEmitterHandles()) {
      ...
      for (FNiagaraVariableWithOffset const& VarWithOffset :
    ...
    if (Operation == TEXT("add_emitter")) {
      FString const SystemPath = Body->GetStringField(TEXT("system_path"));
      FString const EmitterPath = Body->GetStringField(TEXT("emitter_path"));
    ...
    if (Operation == TEXT("remove_emitter")) {
      FString const SystemPath = Body->GetStringField(TEXT("system_path"));
      FString const EmitterName = Body->GetStringField(TEXT("emitter_name"));
      ...
      bool bRemoved = false;
      TArray<FNiagaraEmitterHandle> const& Handles = NiagaraSystem->GetEmitterHandles();
